					   ...
					   <div class="nav-cont">
						...
						<div id="nav" class="navfull">
							<div class="area clearfix">
								...
								<c:if test="${big.goodsparentid eq '0'}">
									<div class="category">
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/${big.goodspic}"></i><a class="ml-22" title="点心">${big.goodsname}</a></h3>
													<em>&gt;</em></div>
														...
														<div class="area-bg">
															<div class="menu-srot">									
																...
																<c:forEach items="${gtList}" var="small">	
																	<c:if test="${big.id eq small.goodsparentid}">	
																	<dl class="dl-sort">															
																		<dt><span title="${small.goodsname}">${small.goodsname}</span></dt>
																		<c:forEach items="${giList}" var="info">
																		<c:if test="${small.id eq info.goods_fatherid}">													
																		<dd><a title="${info.goods_name}" href="ShopServlet?action=getGoodsInfoById&id=${info.id}"><span>${info.goods_name}</span></a></dd>	
																		</c:if>	
																		</c:forEach>	
																	</dl>
																	</c:if>	
