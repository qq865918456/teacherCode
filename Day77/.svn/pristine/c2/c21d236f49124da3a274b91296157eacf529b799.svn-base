    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
            <div class="tab-content default-tab" id="tab1">
                ...
                <form id="formid" action="${pageContext.request.contextPath}/task/chuli" method="post">
                    <fieldset>
                        <input type="hidden" name="cid" value="${caigou.id}"/>
                        ...
                        <p>
                            ...
                            <textarea class="text-input textarea wysiwyg" id="info_id"
                                      name="info" cols="79" rows="15" disabled="disabled">${caigou.info}</textarea>
                        </p>
                        <p>
                            <label>预算</label>
                            <input
                                    class="text-input small-input" type="text" id="money_id"
                                    name="money" value="${caigou.money}" disabled="disabled"/>
                        </p>
                        <p>
                            <label>受理人</label>
                        ...
                        <p>
                            <input class="mybutton" type="button" onclick="taskChuli(true);" value="同意" />
                            <input class="mybutton" type="button" onclick="taskChuli(false);" value="驳回" />
                        </p>
                    </fieldset>
                    <div class="clear"></div>
                    <!-- End .clear -->
