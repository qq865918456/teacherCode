...
<script type="text/javascript">
	$(function() {
		...
		$("#addShopCar").click(function() {
			// 1.获取商品id
			var goodsInfoId = "${param.id}"; // req.getParamxxx("id")
			
			// 2.获取数量
			var count = $("#value").val();
			
			// 3.把数据发送到servlet中然后添加到购物车
			$.get("ShopServlet?action=addShopCar&count=" + count + "&id=" + goodsInfoId,function(){
				location.reload();
			})
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														...
														value="+" /> <span id="Stock" class="tb-hidden">库存
