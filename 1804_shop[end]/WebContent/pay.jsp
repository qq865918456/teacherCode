	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				// 1.先要获取默认的id
				var defaultAddr = $("#default_1");
				
				// 2.添加的外面的框
				defaultAddr.attr("class","user-addresslist defaultAddr");
				
				// 3.添加默认地址
				defaultAddr.find(".address-left").append("<ins class='deftip'>默认地址</ins>");
			})
					...
					<div class="address">
						...
						<ul class="addressChoose">
								...
								<c:forEach items="${addressList }" var="address">
									...
									<li class="user-addresslist" id="default_${address.flag}">
										<div class="address-left" >
											...
											<div class="user DefaultAddr">
												 <span class="buy-address-detail"></span>
		                  						 <span class="buy-phone">收货人</span>
												 <span class="buy-user">${address.username}</span>
											</div>
...
<!-- 												<ins class="deftip">默认地址</ins> -->
					...
					<c:forEach items="${shopCar.list}" var="goodsInfo">
							<!-- 购物车 -->
							<tr class="item-list">
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													...
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">${goodsInfo.goods_descrip }</a>
														</div>
													</div>
												</li>						
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number" id="singlePrice"><fm:formatNumber value="${goodsInfo.count*goodsInfo.goods_price_off}" pattern="#.##"/></em>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">${sessionScope.shopCar.price}</em>
											</span>
										</div>
									...
									<div id="holyshit269" class="submitOrder">
										...
										<form action="ShopServlet?action=pay" method="post" id="form">
